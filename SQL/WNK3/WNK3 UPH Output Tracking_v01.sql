...
-- WNK UPH Output Tracking. created on Sep.03.2021 by JimShen ?????

-- OPITON 1365 MF F/G LEFT JOIN SCANNED INTO CONTAINER'S SN STATUS
...
AND (t1.AATWHS='35') and (t1.AACOD1 = 'MF') AND (AASER# >0 ) AND  AAAPGM = 'DW044BU'
) AS X1 


LEFT JOIN

-- CURRENT AND ARCHIVED UPH SN SA done
(
(SELECT a.WCSSERIALNUMBER,a.WCSCONTAINERNUMBER, b.WCHCONTAINERSTATUS,'SADone' as CNT_STATUS
FROM WWUSAF.WVCNTSD a, WWUSAF.WVCNTHD b 
