...
SELECT WCIORIGIN,Container#,CUBES,ITCLS,PRODUCT,WCIDESTINATION,WCIORDER,ITEMNUMBER,QTY,WCILASTMAINTENANCETIMESTAMP,CONTAINERNUMBER,
...
s1.itcls,s1.UnitCube,s1.UnitWeight,s1.Cubes,s1.Product,s2.ContainerType,to_char(s1.WCILASTMAINTENANCETIMESTAMP,'yyyy-mm-dd') as Date, 
...
(Select x1.Container#, x1.WCHCONTAINERSIZE
...
ON Y1.ContainerNumber = Y2.Container#
