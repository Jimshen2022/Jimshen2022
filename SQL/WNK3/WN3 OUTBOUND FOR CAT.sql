...
SELECT T1.CONTAINER#, T1.WCHCONTAINERSIZE, T1.WCIORIGIN, T1.WCIDESTINATION, T1.WCILASTMAINTENANCEUSER, T1.DATE, SUM(T1.QTY) QTY
...
GROUP BY T1.CONTAINER#, T1.WCHCONTAINERSIZE, T1.WCIORIGIN, T1.WCIDESTINATION, T1.WCILASTMAINTENANCEUSER, T1.DATE
