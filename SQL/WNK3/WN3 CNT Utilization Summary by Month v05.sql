-- Updated on Nov.22.2021 for wanek Container Utilization Summary sheet
...
OR (a.WCHACTUALARRIVALMAINTPROGRAM not in ('SVCHECKIN') and WCHBUILDING in ('B1','V3','M3')))
AND a.WCHCONTAINERNUMBER not like 'AIR%' AND a.WCHDESTINATION NOT IN ('100','101','102','12','131','01','3','990')
AND a.WCHPOSTEDTIMESTAMP BETWEEN char(current date - 360 days) and char(current DATE)  and a.WCHORIGIN in ('35') and 
