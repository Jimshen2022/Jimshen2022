-- WNK TRX BY PRODUCT AND INBOUND
...
WHERE t2.ITNBR = t1.ITNBR AND t2.STID = t3.STID AND t1.HOUSE = t3.WHID AND t1.HOUSE IN ('31','33','35') 
AND (t1.UPDDT>=? And t1.UPDDT<=?) AND (t1.TRQTY<>0) and t1.TCODE IN ('SA')

UNION ALL
-- archived data for transaction in WANEK
...
FROM ASHLEYARCW.TBL_IMHIST_ARCHIVE t1, AMFLIBW.ITMRVA t2, AMFLIBW.WHSMST t3  
WHERE t2.ITNBR = t1.IMHITEMNUMBER AND t2.STID = t3.STID AND t1.IMHWAREHOUSE = t3.WHID AND t1.IMHWAREHOUSE IN ('31','33','35') 
