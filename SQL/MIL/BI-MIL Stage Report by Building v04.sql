...
-- MIL Stage report by building, created on Sep.28.2021 by JimShen
...
BETWEEN  int('1'||substr(trim(char(CURRENT DATE - 60 days)),3,2)||substr(trim(char(CURRENT DATE- 60 days)),6,2)||substr(trim(char(CURRENT DATE- 60 days)),9,2)) 
