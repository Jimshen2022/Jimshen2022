-- MIL Container utilization by time range --- 20210812
...
and  a.WCILASTMAINTENANCETIMESTAMP  between '2020-12-01-00.00.00.000000' and '2021-12-31-23.59.59.999999'
...
between '2020-12-01-00.00.00.000000' and '2021-12-31-23.59.59.999999'  AND substr(a.WCICONTAINERNUMBER,1,4) NOT IN ('AAAR','AIIR','AAIR','AIRR','AIR_','AIR1')
