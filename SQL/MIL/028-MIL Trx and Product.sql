...
AND t1.UPDDT BETWEEN CHAR('1'||VARCHAR_FORMAT(CURRENT DATE - 90 Days,'YYMMDD')) AND CHAR('1'||VARCHAR_FORMAT(CURRENT DATE,'YYMMDD')) AND t1.TRQTY<>0 AND t1.tcode IN ('SA')
