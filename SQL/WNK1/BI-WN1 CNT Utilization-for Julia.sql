-- Updated on Aug.30.2021 for wanek1 Container Utilization detail sheet
...
WHERE a.WCHCONTAINERSTATUS in ('P','T') AND a.WCHORIGIN IN ('31')  AND a.WCHPOSTEDTIMESTAMP BETWEEN char(current date - 150 days) and char(current DATE) 
...
WHERE a.WCHCONTAINERSTATUS in ('P','T') AND a.WCHPOSTEDTIMESTAMP BETWEEN char(current date - 150 days) and char(current DATE)  and a.WCHORIGIN in ('31') and 
...
-- Updated on Aug.30.2021 for wanek1 Container Utilization Summary sheet
