...
FROM
(
SELECT t1.APITNB, t1.APHOUS, t2.iWeek, t2.QTY
FROM  AFILELIB.ATPSUM  t1,
TABLE(
VALUES
('WK1',t1.APAT01),('WK2',t1.APAT02),('WK3',t1.APAT03),('WK4',t1.APAT04),('WK5',t1.APAT05),('WK6',t1.APAT06),('WK7',t1.APAT07),
...
SELECT t1.APITNB, t1.APHOUS, t1.APWK01 t2.iWeek, t2.QTY
FROM  AFILELIB.ATPSUM  t1,
TABLE(
VALUES
('WK1',t1.APAT01),('WK2',t1.APAT02),('WK3',t1.APAT03),('WK4',t1.APAT04),('WK5',t1.APAT05),('WK6',t1.APAT06),('WK7',t1.APAT07),
...
--  DB2行列转换——pivot/unpovit   https://blog.csdn.net/u012486638/article/details/81123221
