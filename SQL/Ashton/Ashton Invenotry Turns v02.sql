...
SELECT a.HOUSE, a.Week, a.YEAR, a.Product, a."TYPE", a.YEAR*100+a.Week as "YearWeek", SUM(a.TRQTY) TRQTY, SUM(a."AMT($USD)") AS "AMT($USD)"
FROM
(
...
GROUP BY a.HOUSE, a.Week, a.YEAR, a.Product, a.TYPE,  a.YEAR*100+a.Week
ORDER BY  a.YEAR*100+a.Week
