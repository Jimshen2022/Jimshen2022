-- Updated on May.09.2022 for WN2 Container Utilization Summary sheet
Select 
...
substr(trim(a.WCHCONTAINERNUMBER),1,4) NOT IN ('AAAR','AIIR','AAIR','AIRR','AIR_','AIR1','AAII','ARRR','ABCD')) as x1